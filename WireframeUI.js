...
const WireframeUI = () => {
  ...
  const handleTileTypeSelect = (event, index) => {
    handleAddTile(event.target.value, index);
  };
              ...
              <input
                ...
                {tile.type !== 'end' && (
                  <div className="add-tile">
                    <select onChange={(event) => handleTileTypeSelect(event, index)}>
